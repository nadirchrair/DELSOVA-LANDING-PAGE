...
function Presentation() {
  ...
  return (
    <section
      ...
      className="w-full flex flex-col lg:flex-row items-center justify-between px-6 lg:px-16 py-12 lg:py-16 bg-[#f9fcf8] gap-8 lg:gap-12"
    >
      {/* === LEFT SIDE === */}
      <div className="w-full lg:w-1/2 flex flex-col gap-6 lg:gap-8">
        <div className="space-y-4">
          <h1
            id="hero-heading"
            className="text-[#0e1934] text-3xl lg:text-5xl xl:text-6xl font-bold leading-tight"
          >
        ...
        <ul className="flex flex-wrap gap-3 list-none p-0">
          <li className="flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-md">
            <Sparkles className="w-4 h-4 text-[#4186d8]" aria-hidden="true" />
            <span className="text-sm font-medium text-gray-700">
              Innovation
            </span>
          </li>
          <li className="flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-md">
            <Zap className="w-4 h-4 text-[#964cb2]" aria-hidden="true" />
            <span className="text-sm font-medium text-gray-700">
              Performance
            </span>
          </li>
        ...
        <div className="mt-2">
          <button
            ...
            aria-label="Ouvrir le formulaire pour réserver une réunion"
      ...
      {/* === RIGHT SIDE — Responsive picture (WebP + fallback) === */}
      <div className="w-full lg:w-1/2 flex justify-center mt-8 lg:mt-0">
        <div className="relative w-full max-w-md lg:max-w-[550px] h-full lg:h-full rounded-2xl lg:rounded-[30px] shadow-2xl overflow-hidden">
          <picture>
            <source
              type="image/webp"
              srcSet="/assets/home-mobile.webp 640w, /assets/home.webp 1200w"
              sizes="(max-width: 640px) 90vw, (max-width: 1024px) 50vw, 550px"
            />
            <img
              src="/assets/home.png"
              alt="Delsova Technologies — illustration de l'innovation, de l'intelligence artificielle et de la digitalisation"
              width="1200"
              height="895"
              loading="eager"
              fetchPriority="high"
